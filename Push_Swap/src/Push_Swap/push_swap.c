...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/23 12:41:24 by creicher          #+#    #+#             */
/*   Updated: 2020/07/23 12:45:55 by creicher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		launch_push_swap(int *arr, int n)
{
	...
	chunk_info.length = n;
	chunk_info.side = A_STACK;
	push_swap(sp, arr, &chunk_info);
	stack_pair_free(&sp);
}

static void	init_chunks(t_chunk_info *current,
						t_chunk_info *left, t_chunk_info *right)
{
